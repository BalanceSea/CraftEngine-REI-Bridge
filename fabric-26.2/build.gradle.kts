...
dependencies {
    ...
    compileOnly("me.shedaniel:RoughlyEnoughItems-api-fabric:26.2.821")
...
tasks {
    ...
    processResources {
        ...
        val props = mapOf(
            ...
            "minecraft_dependency" to "=26.2",
            "loader_dependency" to ">=0.19.3",
            "java_dependency" to ">=25",
            "rei_dependency" to ">=26.2.821"
        )
        inputs.properties(props)
        filesMatching("fabric.mod.json") { expand(props) }
    }
    jar {
        archiveBaseName.set("craftengine-rei-bridge-fabric-26.2")
    }
}
